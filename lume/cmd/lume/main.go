...
import (
	...
	"github.com/Rheinmir/lume/internal/version"
	"github.com/Rheinmir/lume/internal/webhook"
	"github.com/Rheinmir/lume/server"
	"github.com/Rheinmir/lume/store"
	"github.com/Rheinmir/lume/store/db"
)
...
func printGreetings(profile *profile.Profile) {
	...
	fmt.Printf("Source code: %s\n", "https://github.com/Rheinmir/lume")
	fmt.Println("\nHappy note-taking!")
}
