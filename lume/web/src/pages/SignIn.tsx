  ...
  return (
    <div className="py-4 sm:py-8 w-80 max-w-full min-h-svh mx-auto flex flex-col justify-start items-center">
      <div className="w-full py-4 grow flex flex-col justify-center items-center">
        <div className="w-full flex flex-row justify-center items-center mb-8 gap-3">
          <span
            className="grid place-items-center"
            style={{
              width: 52, height: 52, borderRadius: 18, background: "var(--neu-bg)",
          ...
          >
            <span
              style={{
                ...
                boxShadow: "inset 1px 1px 2px rgba(0,0,0,.18)",
              }}
            />
          </span>
          <p className="text-4xl font-semibold tracking-tight" style={{ color: "var(--neu-ink)" }}>
            {instanceGeneralSetting.customProfile?.title || "Lume"}
          </p>
        </div>
