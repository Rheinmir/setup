...
- [Report bugs](https://github.com/Rheinmir/lume/issues/new?template=bug_report.md)
- [Suggest features](https://github.com/Rheinmir/lume/issues/new?template=feature_request.md)
- [Submit pull requests](https://github.com/Rheinmir/lume/pulls)
- [Improve documentation](https://github.com/usememos/dotcom)
- [Help with translations](https://github.com/Rheinmir/lume/tree/main/web/src/locales)
