...
- **C15.8/FE-21**: `GET /report/attendance-detail?period=` hiện cảnh báo "BÁO CÁO NHẠY CẢM" + "CHƯA có kiểm soát truy cập" (carve-out bảo mật — route KHÔNG hạn chế ai xem); tổng ngày công từng người khớp `engine.compute("PAID_DAYS", ...)` thật, kể cả ground-truth `2026-03`
