...
created_by: slicer
parent_br: br/BR.md
clause_ids: [C15.1, C15.2, C15.4, C15.5, C14.1, C14.2]
parent_br_hash: 5c0174e8f467b73db5a18477ae072a76e12d9f6e83ce4dc8217d3cd89ad71652
muc_tieu: "Sáu màn hình cho HR — bảng lương toàn kỳ, phiếu lương từng người theo đúng mẫu thật, cây truy vết công thức bấm ngược được từ lương thực nhận xuống tận lương cơ bản, MỘT tab tối giản tải Excel mass-upload thay nhập tay (bắt buộc khai người thực hiện + lý do), sổ audit chỉ-xem ghi lại mọi lần tải (FE-17), và màn Master Data chỉ-xem toàn bộ tham số lương kể cả bộ chưa hiệu lực (FE-23)"
