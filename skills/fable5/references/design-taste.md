...
If the project also has `/hallmark` available, load it for the full implementation
rulebook (palettes, type pairings, design-token system); this reference governs the
judgment and verification layer and never conflicts with it.
