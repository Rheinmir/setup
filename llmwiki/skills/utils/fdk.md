...
- **HTML cho người xem: SÀN CỠ CHỮ** (feedback 2026-07-06) — text đọc chính (body, nav link, list, bảng) ≥ 14px, nhãn/caption ≥ 11px, không dưới 10px trừ badge đếm; đừng co component nhỏ quá mức để nhồi layout. Chi tiết: docs-site-macos § Best Practices.
