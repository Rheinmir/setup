...
- **Chức năng trước thẩm mỹ, không bình quân điểm** (học từ skill `qa` của browser-use, 09/2026):
...
- **Ảnh chụp sạch không chứng minh gì** — khi engine chạy headless, moi thêm lỗi ẩn: console
