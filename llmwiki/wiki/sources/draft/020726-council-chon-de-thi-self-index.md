...
**Nợ để T5 hoàn tất:** report HTML + đưa 3 defect (import-TS-blind, cycle/quarantine-flag, code-fence-strip) vào [[failure-flywheel]] + cập nhật [[020726-wiki-core-relations]].
...
5. Kết quả distill về wiki (concept mới hoặc cập nhật [[020726-wiki-core-relations]]).
