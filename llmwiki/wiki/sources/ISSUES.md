...
| [030726-secondary-memory](draft/030726-secondary-memory.md) | feature-gap | Context/sửa-vụn vụn vặt lưu durable + visualizable (file-first, không RAG) — bộ-nhớ-thứ-cấp nối vào Stop-hook | done | @Rheinmir | /fdk | [GH#5](https://github.com/Rheinmir/setup/issues/5) |
...
| [110726-eval-blinding-grader-context](draft/110726-eval-blinding-grader-context.md) | feature-gap | Evaluation blinding: che context sinh output khỏi grader (KHÁC blind-danh-tính của council) | open | @Rheinmir | /fdk | [GH#71](https://github.com/Rheinmir/setup/issues/71) |
| [110726-anti-fabrication-observed-metrics](draft/110726-anti-fabrication-observed-metrics.md) | feature-gap | Anti-fabrication mở rộng: cấm bịa số đo về người-dùng/thế-giới agent không quan sát | open | @Rheinmir | /fdk | [GH#72](https://github.com/Rheinmir/setup/issues/72) |
| [110726-auto-wire-eval-loop](draft/110726-auto-wire-eval-loop.md) | architecture | Auto-wire loop chống-lạc-quan: grader/anti-fabrication tự-kích qua hook, không đợi gọi skill tay (bao trùm #71/#72) | open | @Rheinmir | /fdk | [GH#73](https://github.com/Rheinmir/setup/issues/73) |
| [110726-gold-set-meta-eval-grader](draft/110726-gold-set-meta-eval-grader.md) | feature-gap | Gold-set + QWK meta-eval: đo độ ĐÚNG của chính grader (ai chấm người-chấm) | open | @Rheinmir | /fdk | [GH#74](https://github.com/Rheinmir/setup/issues/74) |
| [110726-shipped-vs-documented-parity](draft/110726-shipped-vs-documented-parity.md) | tech-debt | Parity ship: tài liệu hứa N năng lực nhưng installer chỉ giao M | done | @Rheinmir | /fdk | [GH#77](https://github.com/Rheinmir/setup/issues/77) |
...
| [070726-ponytail-distill](draft/070726-ponytail-distill.md) | process | Chưng cất Ponytail: ladder chống over-engineering + marker nợ + nâng /simplify | open | @Rheinmir | /fdk | [GH#68](https://github.com/Rheinmir/setup/issues/68) |
