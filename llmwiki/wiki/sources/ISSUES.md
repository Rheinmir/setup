...
| [200726-code-graph-index-broken](draft/200726-code-graph-index-broken.md) | foundation | code-graph MCP hỏng: đường ghi/đọc lệch DB — mọi phiên vẫn được khuyên dùng trước (A/B: 2.64× đắt, cùng độ chính xác) | open | maintainer | /fdk | _(ledger-only)_ | ready-for-human | _(none)_ | _(none)_ |
