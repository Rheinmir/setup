...
| `entities/` | Thứ tồn tại cụ thể trong hệ thống: service, API, component, tool | `cognee.md`, `neo4j.md` |
| `sources/` | Tài liệu tham khảo ngoài, ADR, quyết định kỹ thuật đã distill từ `raw/` | `why-neo4j.md` |
